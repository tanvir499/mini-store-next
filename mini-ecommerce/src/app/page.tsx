        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-slate-600 leading-relaxed">
                  Explore our curated collection of cutting-edge electronics, from wireless audio to smart wearables and essential accessories.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700 font-medium">Premium Quality Guaranteed</span>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-700 font-medium">Free Express Shipping</span>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/items"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-2xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                ...
                <Link
                  href="/categories"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-slate-300 text-slate-700 font-semibold rounded-2xl hover:border-slate-400 hover:bg-slate-50 transition-all duration-300"
                >
                  Browse Categories
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-3xl p-6 shadow-lg border border-slate-100 text-center group hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Audio</h3>
                <p className="text-slate-600 text-sm">Premium headphones & speakers</p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-lg border border-slate-100 text-center group hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Wearables</h3>
                <p className="text-slate-600 text-sm">Smart watches & fitness trackers</p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-lg border border-slate-100 text-center group hover:shadow-xl transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-2">Electronics</h3>
                <p className="text-slate-600 text-sm">Smartphones, tablets & laptops</p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-lg border border-slate-100 text-center group hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-slate-600 text-sm">Cases, chargers & peripherals</p>
              </div>
            </div>
          </div>
        </div>
